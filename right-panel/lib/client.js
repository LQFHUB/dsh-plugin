window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const tagId$4 = "dsh-right-panel/scm.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$4) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-right-panel";
		...
		*/
		...
		const tagId$3 = "dsh-right-panel/explorer.module.css";
		...
		const tagId$2 = "dsh-right-panel/tokens.module.css";
		...
		*/
		...
		const tagId = "dsh-right-panel/drag.module.css";
